...
const Dashboard = () => {
      ...
      <div className="p-4 space-y-6 h-full overflow-y-auto">
        ...
        <Card className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-purple-200/50 dark:border-purple-800/30 shadow-lg hover:shadow-xl transition-all duration-300 hover-lift">
          ...
          <CardContent>
            ...
            <Button 
              variant="outline" 
              className="mt-4 w-full border-purple-200 text-purple-700 hover:bg-purple-50 hover:border-purple-300 dark:border-purple-700 dark:text-purple-300 dark:hover:bg-purple-900/30 transition-all duration-200" 
              onClick={logout}
            >
              Sign Out
            </Button>
            ...
            {navigationItems.map((item) => (
              <Button
                ...
                className={`w-full justify-start transition-all duration-200 ${
                  activeTab === item.id
                    ? "bg-purple-gradient text-white shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-100 dark:from-gray-900 dark:via-purple-900/10 dark:to-gray-800">
      {/* Mobile overlay */}
      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Mobile Header */}
          {isMobile && (
            <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-purple-200/50 dark:border-purple-800/30 p-4 sticky top-0 z-30">
              <div className="flex items-center justify-between">
                <Button
                  variant="ghost"
                  size="sm"
                  ...
                  <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border border-purple-200/50 dark:border-purple-800/30 shadow-lg">
                    {navigationItems.map((item) => (
                      <TabsTrigger
                        key={item.id}
                        value={item.id}
                        className="data-[state=active]:bg-purple-gradient data-[state=active]:text-white data-[state=active]:shadow-md transition-all duration-200 text-xs sm:text-sm font-medium"
                      >
